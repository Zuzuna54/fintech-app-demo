...
/**
 * Error page component for the accounts route.
 * Displays when an error occurs within the accounts page or its children.
 */
            ...
            >
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            An error occurred while loading the accounts page
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
